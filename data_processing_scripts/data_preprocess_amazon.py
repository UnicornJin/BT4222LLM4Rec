...
#
# This file contains transforming Amazon Review Dataset 
# from raw format to matrix. 
# 
...
def add_comma(num):     # e.g. 1000000 -> 1,000,000
    str_num = str(num)
    res_num = ''
...
# If you want to try other categories, you need to change the variable:

short_data_name = 'luxury'
...
elif short_data_name == 'appliances':
    full_data_name = 'Appliances'
else:
...
# Initialize process of the dataset

# Filter out the needed attributes,
...
# ------------------------------------------------
# Define Functions to Extract Content Information
...
def main(data_name, acronym, data_type='Amazon'):
    ...
    # rating score smaller than this score would be deleted
    rating_score = 3.0  
    ...
    print('Begin extracting reivew infos...')
...
# ------------------------------------------------
# Processing the Interaction Data and Save as Sparse Matrices
#
...
# ------------------------------------------------
# Processing the Item-Specific Textual Data
...
# ------------------------------------------------
# Processing the Textual Data Associated with a User/Item Pair
review_data = []
