...
self_running_model_save_dir = './checkpoints/self-running/pretrain/'
...
def main():
    ...
    # Load data for content-based part, which is the: review text data
    ...
    # Load data for collaborative part, which is the: user/item interaction data
